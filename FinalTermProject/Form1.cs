    ...
    public partial class Home : Form
    {
        ...
        private void button4_Click(object sender, EventArgs e)//ADD Admin
        {
            if (textBox2.Text != "" && textBox3.Text != "")
            {
                ...
                {
                    LinqLoginDataContext lq = new LinqLoginDataContext(@"Data Source=(LocalDB)\v11.0;AttachDbFilename=D:\Study\Sem 8\OOP2 (C#)\Final\Project\FinalTermProject v2.0\FinalTermProject\FinalTermProject\Admindata.mdf;Integrated Security=True;Connect Timeout=30");
                    Login lg = new Login
                    {
